...
architecture tb of tb_cpu_pipeline is
        ...
        if rising_edge(clk) then
            if rst = '0' then
                case instr is
                    ...
                    when INSTR_LW   => v_instr_name := "LW                  ";
                    when INSTR_BEQ  => v_instr_name := "BEQ                 ";
                    when INSTR_BNE  => v_instr_name := "BNE                 ";
                    when INSTR_BLT  => v_instr_name := "BLT                 ";
                    when INSTR_BGE  => v_instr_name := "BGE                 ";
